...
<h2 className='text-center my-4 font-bold text-3xl'>Create new post</h2>
      </div>
      <hr />
    ...
    class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" 
    height="77" role="img" viewBox="0 0 97.6 77.3" width="96"><title>Icon to represent media such as images or videos</title>
    ...
    fill="currentColor"></path></svg>
        ...
        <h2 className='text-2xl'>Drag photos and videos here</h2>
        <div className='text-center'>
        <button className='font-semibold px-4 py-2 rounded-xl bg-blue-500 hover:bg-blue-700 text-white'>Select from computer</button>
